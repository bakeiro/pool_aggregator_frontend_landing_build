import{j as e}from"./index-Bz8Edr0C.js";import{M as r,r as h,a as l,h as c,o as d}from"./one-dark-DFNglgq5.js";const m={title:"Uniswap V3 Calculator Error: Why Poolfish and DeFiLabs Are Showing You Wrong Data — and What to Use Instead",slug:"big-error-uniswap-v3-calculators",date:"2026-03-03",description:"Big Uniswap V3 Calculator Error",author:"PoolMaster",cover:"/images/my-article/portada.jpg",lang:"en"},u=`
...
Only an <span style="background-color: #00c951">**$11 million difference in TVL**</span>. No big deal, right?
...
- [Open issue on DeFiLabs' GitHub repository](https://github.com/DefiLab-xyz/uniswap-v3-simulator/issues/2)`,p={code({node:o,inline:t,className:a,children:s,...i}){const n=/language-(\w+)/.exec(a||"");return!t&&n?e.jsx(c,{style:d,language:n[1],PreTag:"div",...i,children:String(s).replace(/\n$/,"")}):e.jsx("code",{className:a,...i,children:s})},img({src:o,alt:t,...a}){return e.jsx("img",{src:o,alt:t,loading:"lazy",style:{maxWidth:"100%",height:"auto",borderRadius:8},...a})}};function b(){return e.jsx("article",{className:"prose prose-lg max-w-none dark:prose-invert",children:e.jsx(r,{remarkPlugins:[l],rehypePlugins:[h],components:p,children:u})})}export{b as default,m as meta};
